    ...
    params: {
      ...
      meta: {
        ...
        ...(ctx.message?.reply_to_message ? {
          ...
          ...(ctx.message.reply_to_message.from?.id != null ? { reply_to_user_id: String(ctx.message.reply_to_message.from.id) } : {}),
          ...(ctx.message.reply_to_message.text ? { reply_to_text: ctx.message.reply_to_message.text.slice(0, 200) } : {}),
        } : {}),
      },
    },
  }).catch(err => {
